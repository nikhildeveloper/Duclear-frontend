...
// wrapped to access the date from other components
  return (
    <DateContextContextProvider value={{date, storeDate, Action, storeActionValue}}>                      
    <section class="bg-white z-30">
        {alertToggle && <SuccessAlert/>}
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
        
        <section class="relative flex h-32 items-center bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
        ...
        <div class="hidden lg:relative lg:block lg:p-12">
            ...
            Every penny counts. Log it here!
            </p>
        </div>
        </section>
        ...
        <div class="max-w-xl lg:max-w-3xl">
            ...
            <div class="col-span-6 sm:col-span-3">
                <label  class="block font-medium text-gray-700 text-lg">
                Item
                </label>
            ...
            <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
                <button
                class="inline-block shrink-0 rounded-md border border-orange-600 bg-orange-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-orange-600 focus:outline-none focus:ring active:text-blue-500"
                onClick = {passText}
                >
                Add
                </button>
